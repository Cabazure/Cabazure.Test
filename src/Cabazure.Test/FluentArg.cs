...
/// <summary>
/// Provides AwesomeAssertions-based argument matchers for use with NSubstitute's
/// <see cref="NSubstitute.SubstituteExtensions.Received{T}(T, int)"/> assertions.
/// </summary>
public static class FluentArg
{
    /// <summary>
    /// Creates an argument matcher that uses AwesomeAssertions to verify the argument.
    ...
    /// the AwesomeAssertions assertions (e.g. <c>r.Name.Should().Be("Alice")</c>).
    /// </param>
...
/// <summary>
/// NSubstitute argument matcher that delegates match evaluation to an AwesomeAssertions assertion action.
