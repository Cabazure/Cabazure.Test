...
### Project-wide customizations via `SutFixtureCustomizations`
...
| `SutFixtureCustomizations` | Global customization registry — call `Add(customization)` from a `[ModuleInitializer]` to apply it to every fixture. |
